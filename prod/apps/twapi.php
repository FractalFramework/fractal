...
list($id,$command,$mode,$opt)=vals($p,['id','command','mode','opt']);
...
list($command,$mode,$max,$min,$opt,$sens)=vals($p,['command','mode','max','min','opt','sens']);
