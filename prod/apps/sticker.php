...
add_head('csscode','.sticker{font-family:Ubuntu; font-size:24px; text-align:center; padding:40px 20px; background-size:cover; background-position:center center;}
