...
//sqlcreate(self::$db3,['cid'=>'int','bid'=>'int','val'=>'var'],1);
sqlcreate(self::$db2,['bid'=>'int','uid'=>'int','root'=>'bvar','element'=>'text','tag'=>'int'],1);
...
if($r)foreach($r as $k=>$v)$ret.=$a::$b($k,$v);
return $ret;}
