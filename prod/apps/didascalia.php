<?php
class didascalia extends appx{
static $private=0;
static $a=__CLASS__;
static $db='didascalia';
static $cb='dlg';
static $cols=['tit','pub'];
...
static $gen=0;
static $tags=1;
static $db2='didascalia_r';
//static $db3='didascalia_persos';
static $open=1;
static $qb='db';
...
sqlcreate(self::$db2,['bid'=>'int','perso'=>'var','dialog'=>'text'],1);//subcall case
//sqlcreate(self::$db3,['bid'=>'int','perso'=>'tiny','description'=>'var'],1);
