...
sqlcreate(self::$db2,['bid'=>'int','row'=>'int','col'=>'int','colspan'=>'int','rowspan'=>'int','situation'=>'var','dialog'=>'var','img'=>'svar','clr'=>'svar'],1);
...
foreach($rb as $k=>$v){$txt='';
	...
	if($v['img'])$sz.='background-image:url('.playimg($v['img'],'',2).'); background-size:cover; ';
