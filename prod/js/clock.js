...
var clck={cb:"clk2",sz:300,sc:0.5};

function clock(){
var cb=clck.cb; var sz=clck.sz; var sc=clck.sc;
var mid=clck.sz/2; var tiers=sz/3; var t2=tiers*2;
...
needle(ctx,rot,tiers,t2);
ctx.restore();

ctx.save();
//ctx.rotate(Math.PI/2); ctx.font="36px sans"; ctx.fillText(rot+"-"+(Math.PI/30)*dt.mn,0-80,mid);
ctx.restore();
...
var tx=0-tz.width/2-10; var ty=mid-32; var tw=tz.width+20; var th=40;
ctx.strokeStyle="#325FA2";
...
ctx.fillStyle="black";
ctx.fillText(hour,0-tz.width/2,mid);
ctx.restore();
