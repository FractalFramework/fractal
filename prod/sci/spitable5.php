...
static function circularpos($ring,$subring,$pos){
...
$ret='[black:attr]';//,,,14px
$j='spt|spitable5,call|p1='.$i.',|mode,clr,helico';
...
$ret.=bj($rid.'|spitable5,call|mode=diamond|lbar,clr',lang('diamond'),'btn'.active($o,'diamond')).' ';
$ret.=bj($rid.'|spitable5,call|mode=circular|lbar,clr',lang('circular'),'btn'.active($o,'circular')).' ';
$ret.=bj($rid.'|spitable5,call|mode=layers|lbar,clr',lang('layers'),'btn'.active($o,'layers'));
return div($ret);}
