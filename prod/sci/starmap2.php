...
list($white,$black,$red,$green,$blue,$yellow,$cyan,$orange,$silver,$gray)=starlib::$clr;
...
list($white,$black,$red,$green,$blue,$yellow,$cyan,$orange,$silver,$gray)=starlib::$clr; $clrg='#777';
...
list($p1,$p2,$p3,$p4)=vals($p,['p1','p2','p3','p4']);
...
$ret.=inputcall($j,'p2',$p2?$p2:30,4,'limit').' ';
$ret.=inputcall($j,'p4',$p4?$p4:740,4,'width').' ';
...
list($p1,$p2,$p3,$p4)=vals($p,['p1','p2','p3','p4']); $rid=('stm2');
