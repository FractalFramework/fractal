...
list($white,$black,$red,$green,$blue,$yellow,$cyan,$silver,$gray)=imgclr_pack($im);//spe
foreach($r as $k=>$v){
	$ad=$v['ad']; $ad-=90; 
...
list($white,$black,$red,$green,$blue,$yellow,$cyan)=self::clr($im,'');
