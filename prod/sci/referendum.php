...
'ep2012'=>',hollande,bayrou,sarkozy,élenchon,dupont-aignan,joly,poutou,lepen,arthaud,cheminade;12,12,15,12,16,16,12;9,12,20,25,22,10,3;32,8,11,11,16,12,10;25,14,17,15,13,10,5;34,26,20,11,6,2,1;39,25,15,12,7,3,1;46,28,12,8,4,1,0;48,6,14,9,10,7,6;50,25,13,7,4,1,0;52,27,12,6,2,0,0',
'ep2017'=>',mélenchon,macron,hamon,dupont-aignan,lepen,poutou,fillon,lassale,arthaud,asselineau,cheminade;16,11,9,29,22,13;20,11,11,26,23,9;21,15,17,29,12,6;24,20,18,24,10,4;34,14,7,16,14,15;26,23,17,23,8,2;34,18,11,18,12,7;29,27,19,20,4,1;29,28,16,19,6,2;32,31,17,17,3,0',
'ep2022'=>',E. Philippe,N. Hulot,R. Bachelot, X. Bertrand, N. Sarkozy, B. Le maire, JY Le Drian,O. Véran, M. Le Pen, F. Baroin, M. Marechal, E. Zemmour, O. Besancenot, A. Montebourg,JL Mélenchon,M. Barnier,V. Pécresse,Y. Jadot,P. Juvin,F. Roussel,A. Hidalgo,N. D-Aignan,E. Ciotti,F. Philippot;18,17,19,32,14;22,18,19,32,9;22,20,25,29,4;26,22,21,25,6;15,31,23,24,7;29,20,21,25,5;35,17,18,24,6;24,25,22,24,5;11,45,16,17,11;37,17,19,21,6;21,36,17,17,9;16,45,14,16,9;30,30,17,19,4;30,21,27,20,2;15,43,21,15,6;42,15,18,20,5;28,20,24,22,6;35,21,22,18,4;61,15,15,7,2;54,19,15,9,3;21,37,24,15,3;26,35,19,16,4;38,30,19,10,3;29,40,17,12,2',
'ep2022'=>',E. Philippe,N. Hulot,R. Bachelot, X. Bertrand, N. Sarkozy, B. Le maire, JY Le Drian,O. Véran, M. Le Pen, F. Baroin, M. Marechal, E. Zemmour, O. Besancenot, A. Montebourg,JL Mélenchon,M. Barnier,V. Pécresse,Y. Jadot,P. Juvin,F. Roussel,A. Hidalgo,N. D-Aignan,E. Ciotti,F. Philippot;45,19,32,14;40,19,32,9;42,25,29,4;48,21,25,6;46,23,24,7;49,21,25,5;52,18,24,6;49,22,24,5;56,16,17,11;54,19,21,6;57,17,17,9;61,14,16,9;60,17,19,4;51,27,20,2;58,21,15,6;57,18,20,5;48,24,22,6;56,22,18,4;76,15,7,2;73,15,9,3;58,24,15,3;61,19,16,4;68,19,10,3;69,17,12,2'];}
...
list($k1,$v1)=judgment::maxk($rd1); list($k2,$v2)=judgment::maxk($rd2);
...
static function best11($rb,$rm,$rt,$m,$n,$o){$re=[]; $rc=[]; $k1=''; $na=0; $ok=1; $rt=self::$ra;
...
static function cod($d){$r=explode("\n",str_replace(';',"\n",$d)); $rt=[];
foreach($r as $k=>$v){$rb=explode(',',$v);
	if(!is_numeric($rb[0]))self::$rn=$rb; else 
	foreach($rb as $kb=>$vb)for($i=0;$i<$vb;$i++)$rt[$k][]=$kb+1;} //pr($rt);
return $rt;}
...
static function buildatas($r,$ra,$s="\n"){$n=0; if(!isset($ra[0]))array_unshift($ra,''); $rb[0]=$ra;
