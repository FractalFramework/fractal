...
$ret.=bj('admpc,,x|admin_icons,update|id='.$p['id'].',rid='.$rid.'|'.$rid,lang('save'),'btsav');
$ret.=bj('admpc,,x|admin_icons,del|id='.$p['id'],lang('del'),'btdel');
...
if($p['ok']??''){
	...
	//return self::com([]]);
	return bj('admpc,,x|'.self::$a.',com',lang('ok'),'btn');}
...
if(auth(6)){
	...
	$ret.=bj('popup|icons',pic('pictos'),'btn');
	$ret.=bj('admpc|admin_icons',pic('reload'),'btn');
