...
static $dr=['prog','fonts','cnfg/site.com.php','disk/db/sys','usr/tlex/','tar','amt.php','api.php','boot.php','call.php','index.php','pub','disk/json/system/colors.json','disk/db/system/connectors.php','img/full/82e1fe.png','usr/_pub','usr/_db','favicon.ico','version.txt'];
...
$f=serv().'/api/update/mth:localfdates';//distant
$d=get_file($f);
...
$distfdates=get_file(serv().'/api/update/mth:localfdates');
...
if($r)foreach($r as $k=>$v){
	$f=serv().'/api/update/mth:dlfile,file:'.$v;
