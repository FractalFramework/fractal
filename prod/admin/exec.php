...
$rid=val($p,'rid',randid('md')); $ind=val($p,'ind',date('ymd')); $d=val($p,'code');
...
$j='input,code'.$p['rid'].'|exec,read||ind'; $dr='disk/_/';
...
$ret.=self::edit($p);
return div(div($ret,'col1').div('','col2 board scroll',$p['rid'],'max-height:800px;'),'grid wrapper','','grid-column:2; grid-template-columns: 45% 55%; min-width:880px;');}
}
?>
