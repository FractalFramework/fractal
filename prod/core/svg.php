<?php
class svg{
static $r=[],$w=600,$h=440,$t='',$fit=0,$ret=[];
...
[popup|core/txt|txt=hello*[20,20*hello:text]:bj]
[rand,red,2:attr][M150 0 L75 200 L225 200 Z:path][M10,50 A 50 20 0 1 1 110,50:path]
[purple,,,,,,rotate(330 40/20):attr][10,100*hello:text]
[blue:attr][280,140,http://philum.fr*[80,20,,1*philum:text]:a]
[480,20*[80,20*hello1:tspan][green:attr][80,40*hello2:tspan]:text]
[*[f1,0,0*[SourceGraphic,15:feGaussianBlur]:filter]:defs][rand,,,,0.4:attr][300,200,200,1:circle]';
$r['aliensky']='[*[grad1,0%,0%,0%,100%*[0%,rand:stop][100%,rand:stop]:linearGradient]:defs][,,,,,,,grad1:attr][0,0,600,400:rect]
...
$r['animate']='[100,100,10*[r,XML,1;100;1,0s,10s,3:animate][fill-opacity,css,0.1;1;0.1,0s,10s,indefinite:animate]:circle]';
...
'attr'=>['fill','stroke','stroke-width','size','fill-opacity','stroke-dasharray','transform','fillurl'],//transform:rotate(30 20/40)//dash:5/5,//skewY(30)//scale(30)
...
'path'=>['d','id'],//M150 0 L75 200 L225 200 Z //M10 50 A 50 20 0 1 1 110 50
...
'bubj2'=>['j','txt'],
'js'=>['code'],
'animate'=>['attributeName','attributeType','values','begin','dur','repeatCount'],//[r,XML,1;200;1,0s,10s,10:animate][fill-opacity,css,0.1;1;0.1,0s,30s,indefinite:animate]
...
$rb=explode(',',$p); if(isset($ra[$c]))$pr=combine($ra[$c],$rb); self::sz($pr);
if($c=='attr')self::$r['attr']=$pr; elseif(self::$r['attr'])$pr=merge($pr,self::$r['attr']);
...
if($c=='group')$c='g';
if(isset(self::$r['verbose']))echo tabler([$c]+$pr,1,1); //echo $p.'-'.$o.'-'.$c.br();
...
if(isset(self::$r['verbose']))eco($ret);
self::$ret=[];
return $ret;}
