...
sql::create(self::$db.'_clients',['name'=>'var','firstname'=>'var','adress'=>'var','phone'=>'int'],1);
sql::create(self::$db.'_meals',['name'=>'var','cook'=>'var'],1);
sql::create(self::$db.'_delivery',['name'=>'var','geo'=>'var'],1);
sql::create(self::$db.'_orders',['idclient'=>'int','iddelivery'=>'int'],1);
