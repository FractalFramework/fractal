...
for($i=1;$i<10;$i++)
$bt.=bj($rid.'cb|pad,call|rid='.$rid.',m='.$i,$i,act($m,$i),['onclick'=>atj('memStorage',$rid.'_m'.$i.'_res_1')]);
//$bt.=btj($i,atj('memStorage',$p['rid'].'_m'.$i.'_res_1'),act($m,$i),'ckb'.$i);
$ret=span($bt,'nbp');
