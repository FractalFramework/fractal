...
static function dragline($t,$id,$j=''){return tag('div',['id'=>$id,'class'=>'dragme','draggable'=>'true','ondragstart'=>'drag_start(event)','ondragover'=>'drag_over(event)','ondrop'=>'drag_drop(event,\''.$j.'\')','ondragend'=>'drag_end(event)','ondragleave'=>'drag_leave(event)'],$t);}
