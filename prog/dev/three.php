...
static function injectJs(){return ses('thrjs');}
static function headers(){
//html,body{overflow:hidden; width:100%; height:100%; padding:0; margin:0;}
//.canvas{width:100%; height:100%; touch-action:none;}
add_head('jscode','body{overflow: hidden;color:white;text-align:center;}
...
add_head('meta',['attr'=>'name','prop'=>'viewport','content'=>'width=device-width, initial-scale=1']);
//add_head('rel',['name'=>'icon','value'=>'https://discoverthreejs.com/favicon.ico']);
//add_head('jslink','https://threejs.org/build/three.js');
add_head('jslink','/prog/js/three.min.js');
