...
sqlcreate(self::$db2,['bid'=>'int','fullname'=>'svar','organisation'=>'svar','mail'=>'svar','phone'=>'svar','web'=>'svar','address'=>'svar','tags'=>'svar','txt'=>'bvar'],1);
...
list($nm,$pj,$mail)=sql('fullname,project,mail',self::$db,'rw',$v['id']);
