// JavaScript Document
/**
 * Script to save and restore a selection by using invisible marker elements
 * at the selection boundaries.
 *
 * Written by Tim Down.
 * Last modified: 26/6/2010
 *
...
var createSelectionUtil = function(win) {
	...
	if ( isHostObject(win, "document") ) {
		...
		} else if ( isHostObject(win.document, "selection") ) {
			getSelection = function() { return win.document.selection; };
		}
