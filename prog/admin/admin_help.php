...
sqlcreate(self::$db,['ref'=>'var','txt'=>'text','lang'=>'var'],1);}
...
$nid=sqlsav(self::$db,[$p['ref'],$p['txt'],$p['lang']]);
return self::com($p);}

static function addfrom($p){
$p['voc']=yandex::com(['from'=>$p['from'],'to'=>$p['lang'],'txt'=>$p[$p['rid']]]);
$p['id']=sqlsav(self::$db,[$p['ref'],$p['voc'],$p['lang']]);
return self::edit($p);}
