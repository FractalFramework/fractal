...
Server Apache PHP>=7+ MYSQL >5+ and mailing abilities
...
It's used to enter in Dev mode, to change things in ftp before to push them in /Prod.
...
- public static function injectJs(){}//loadable js
- public static function headers(){}//css and js called from url
- public static function admin(){}//admin of the App (like databases, names, pictos, etc.)
- public static function install(){}//definitions of the linked databases to this app (one or more)
- public static function build($p){}//main access to the datas with or without an id
- public static function call($p){}//called from inside
- public static function com($p){}//called from inside
- public static function content($p){}//called by default when opening url /app
- public static function api($p){}//called from url /api/app
